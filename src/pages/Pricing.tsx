        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            ...
            <p className="text-gray-700 mb-6">
              Credits are consumed when you generate story pages, rewrite text, or redraw images. The cost per action may vary slightly depending on the complexity and the AI model used (higher tiers use more advanced models for better results).
            </p>

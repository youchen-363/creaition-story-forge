  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "You start by providing basic parameters for your story, such as title, number of pages, characters, and a story mode. You can then define your characters and upload initial images. Our AI then generates the story text and corresponding visuals, which you can further refine."
        },
        {
          q: "Is CreAItion free to use?",
          a: "CreAItion offers different pricing plans, including a free tier with limited features and credits, as well as paid plans for more extensive story creation. Please refer to our Pricing Page for details."
        },
        {
      ...
      questions: [
        {
          ...
          a: "You can sign up on our Login Page using your email or by connecting with your GitHub account."
        },
        {
          q: "What are 'Credits' and how do I use them?",
          a: "Credits are used to power the AI generation processes within CreAItion, such as generating story pages, rewriting text, or redrawing images. Each generation consumes a certain number of credits, which will be indicated next to the action."
        },
        {
          q: "How can I get more credits?",
          a: "You can purchase additional credits directly from your account by navigating to the 'Add Credit' section in your user dropdown menu. Our Pricing Page provides information on available credit packages."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "While the main story text box is not directly editable, you can use the 'Rewrite' button to regenerate the text for a specific page if you're not satisfied with the initial output."
        },
        {
          q: "What happens if I click 'Redraw' on a story page?",
          a: "The 'Redraw' button generates a new image for the current story page, consuming credits. This is useful if the initial image doesn't quite match your expectations."
        },
        {
          q: "Can I save my story at any point?",
          a: "Stories are automatically saved as you create them. You can access your saved stories from the History Page at any time."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          a: "Please visit our Contact Us Page to send us a message directly, or reach out via email or phone."
        },
        {
          q: "My generated content doesn't make sense. What should I do?",
          a: "AI models can sometimes produce unexpected results. Try using the 'Rewrite' or 'Redraw' buttons. Providing more detailed and specific inputs in the 'New Story' page and character descriptions can also improve results."
        },
        {
